namespace Bloxstrap.Integrations
{
    public class ActivityWatcher : IDisposable
    {
        ...
        private void ReadLogEntry(string entry)
        {
            ...
            else if (!InGame && Data.PlaceId != 0)
            {
                ...
                if (logMessage.StartsWith(GameJoiningUniverseEntry))
                {
                    ...
                    // keep the Quickplay page's recently played list up to date
                    Quickplay.RecordRecent(Data.PlaceId, Data.UniverseId);
                ...
                else if (logMessage.StartsWith(GameJoinedEntry))
                {
                    ...
                    // count how long this game gets played for, for the playtime ring
                    Quickplay.StartSession(Data.PlaceId, Data.UniverseId);
        ...
        public void Dispose()
        {
            ...
            // bank the session that was in progress, if any
            Quickplay.EndSession();
