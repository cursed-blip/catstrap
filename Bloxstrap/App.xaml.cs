...
namespace Bloxstrap
{
    ...
    public partial class App : Application
    {
        ...
        public const string ProjectRepository = "cursed-blip/catstrap";
        public const string ProjectDownloadLink = "https://github.com/cursed-blip/catstrap/releases";
        public const string ProjectHelpLink = "https://github.com/bloxstraplabs/bloxstrap/wiki";
        public const string ProjectSupportLink = "https://github.com/cursed-blip/catstrap/issues/new";
        public const string ProjectRemoteDataLink = "https://config.catstrap.app/v1/Data.json";
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            else
            {
                ...
                string? logSuffix = LaunchSettings.AssetProxyFlag.Active ? "AssetProxy"
                    : LaunchSettings.AssetProxyRepairFlag.Active ? "AssetProxyRepair"
                    : null;

                Logger.Initialize(LaunchSettings.UninstallFlag.Active, logSuffix);
                ...
                Settings.Prop.ApplyPrivacyDefaults();

                FastFlags.Load();
                GlobalSettings.Load();

                Settings.Prop.MigrateAssetProxyRules();

                if (LaunchSettings.AssetProxyRepairFlag.Active)
                {
                    LaunchHandler.LaunchAssetProxyRepair();
                    return;
                }

                if (LaunchSettings.AssetProxyFlag.Active)
                {
                    LaunchHandler.LaunchAssetProxyHost(LaunchSettings.AssetProxyFlag.Data);
                    return;
                }
                ...
                if (Settings.Prop.AllowCookieAccess)
                {
                    Task.Run(async () =>
                    {
                        ...
                        await Integrations.Accounts.AutoSaveAsync();
                    });
                }
