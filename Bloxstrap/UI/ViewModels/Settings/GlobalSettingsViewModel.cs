...
namespace Bloxstrap.UI.ViewModels.Settings
{
    ...
    {
        public FastFlagsViewModel RenderingPresets { get; private set; } = new();

        public void RefreshRenderingPresets()
        {
            RenderingPresets = new FastFlagsViewModel();

            OnPropertyChanged(nameof(RenderingPresets));
        }
