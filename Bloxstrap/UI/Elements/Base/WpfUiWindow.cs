...
namespace Bloxstrap.UI.Elements.Base
{
    public abstract class WpfUiWindow : UiWindow
    {
        ...
        public static readonly Color DefaultAccentColor = AccentTheme.DefaultPrimary;
        ...
        public void ApplyTheme(bool useAcrylic = true)
        {
            ...
            _themeService.SetAccent(AccentTheme.Primary);

            if (App.Settings.Prop.ReduceVisualEffects)
            {
                try
                {
                ...
                {
                    App.Logger.WriteLine("WpfUiWindow::ApplyTheme", $"Could not drop the window backdrop: {ex.Message}");
                }
            }
