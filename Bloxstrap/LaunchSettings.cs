...
namespace Bloxstrap
{
    public class LaunchSettings
    {
        ...
        public LaunchFlag AssetProxyFlag { get; } = new("assetproxy");

        public LaunchFlag AssetProxyRepairFlag { get; } = new("assetproxyrepair");

#if DEBUG
        public bool BypassUpdateCheck => true;
#else
        public bool BypassUpdateCheck => UninstallFlag.Active || WatcherFlag.Active || AssetProxyFlag.Active || AssetProxyRepairFlag.Active;
#endif
